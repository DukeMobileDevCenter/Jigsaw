...
extension ChatViewController {
    ...
    private func reportButton(){
        var actionController = UIAlertController(title: "Report Activity", message: "This is a message", preferredStyle: .actionSheet)
        ...
        // and the game exits
        let reportChatAction = UIAlertAction(title: "Report Chat", style: .destructive){alert in
